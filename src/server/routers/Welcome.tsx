...
import { baseUrl,logoUrl } from "@/emails/constants";

export default function WelcomeEmail({ email, name }: Props) {
  let links = [
    {
      label: "Dashboard",
    ...
    },
    {
      ...
      Description: (
        <li className="mb-20" key={2}>
          <strong>Fill the required details.</strong>
          after that you can either save it as a draft or submit it for review.
        </li>
      ),
    },
    {
      ...
      Description: (
        <li className="mb-20" key={3}>
          <strong>Receive Review.</strong>
          Once your article is reviewed, you will receive an email with the
    ...
    },
    {
      ...
      Description: (
        <li className="mb-20" key={4}>
          ...
          If your article requires any improvements, there will be attached
          comments to help you improve your article.
        </li>
      ),
    },
    {
      ...
      Description: (
        <li className="mb-20" key={5}>
          <strong>Share.</strong>
          Once your article is approved, it will be published on the platform.
        </li>
      ),
    },
  ];
  ...
  return (
    <Html>
      <Head />
      <Preview>Welcome to the LCC Club, {name} 👋</Preview>
      <Tailwind
        config={{
          theme: {
            extend: {
